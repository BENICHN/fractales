...
GLuint useJuliaLocation;
GLboolean fs_useJulia = false;
...
const char *pFSFileName = "shaderJM.fs";
void compileShaders()
{
    ...
    if (pLocation == -1)
    {
        printf("Error getting uniform location of 'p'\n");
        exit(1);
    }
    ...
    useJuliaLocation = glGetUniformLocation(program, "useJulia");
    if (useJuliaLocation == -1)
    {
        printf("Error getting uniform location of 'useJulia'\n");
        exit(1);
    }
...
int main(int argc, char **argv)
{
    ...
    int win = glutCreateWindow("Le JM");
    printf("window id: %d\n", win);
